    ...
    async def _run_schedule(schedule_id: int, profile_id: int, preset: str | None):
        ...
        try:
            ...
            await enqueue_generation(
                ...
                ha_overlay=sched.ha_overlay,
                ha_overlay_position=sched.ha_overlay_position,
                ...
                logo_overlay=sched.logo_overlay,
                logo_position=sched.logo_position,
                logo_size=sched.logo_size,
                logo_opacity=sched.logo_opacity,
