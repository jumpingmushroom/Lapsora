...
async def trigger_schedule(
    ...
    result = await enqueue_generation(
        ...
        period_end=end,
        fps=schedule.fps,
        fps_mode=schedule.fps_mode,
        render_target_seconds=schedule.render_target_seconds,
        ...
        weather_style=schedule.weather_style,
        ...
        logo_overlay=schedule.logo_overlay,
        logo_position=schedule.logo_position,
        logo_size=schedule.logo_size,
        logo_opacity=schedule.logo_opacity,
